...
<html lang="en">
   ...
   <body>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
         <a class="navbar-brand vlavo" href="#">Môj Blog</a>
      ...
      <!-- Banner -->
      <div class="jumbotron">
         <h1 class="display-4 vlavo">Vitajte na mojom blogu!</h1>
         <p class="lead vlavo">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et felis elit. Nunc ornare est
            justo, vel viverra nisi convallis ut.</p>
         <hr class="my-4">
         <p class="vlavo">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed et felis elit. Nunc ornare est justo, vel
      ...
      <div class="container">
         ...
         <footer class="container mt-5">
            ...
            <p>&copy; <?php echo date("Y"); ?> Marek Guráň.</p>
         </footer>
      </div>
